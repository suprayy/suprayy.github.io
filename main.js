...
const makeBook = (title, author, year, isCompleted) => {
  ...
  if(isCompleted) {
    image.setAttribute('src', 'assets/img/after.jpg')
  } else {
    image.setAttribute('src', 'assets/img/before.jpg')
  }
...
const createReadButton = () => {
    return createButton("after-button", function (event) {
...
const createUnreadButton = () => {
  return createButton("before-button", function(event){
